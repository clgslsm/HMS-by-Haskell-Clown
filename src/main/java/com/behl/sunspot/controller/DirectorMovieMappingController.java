...
public class DirectorMovieMappingController {
	...
	public ResponseEntity<List<MovieDto>> getMoviesByDirectorId(
		...
		try {
			return ResponseEntity.ok(directorMovieMappingService.retrieveMoviesByDirectorId(directorId));
	...
	public ResponseEntity<List<DirectorDto>> getDirectorsByMovieId(
		...
		try {
			return ResponseEntity.ok(directorMovieMappingService.retrieveDirectorByMovieId(movieId));
		} catch (InterruptedException | ExecutionException e) {
