...
public class DirectorController {
	...
	@Operation(summary = "Returns A Director Document Corresponding To Provided Id")
	public ResponseEntity<Director> directorRetrievalHandler(
			@PathVariable(name = "directorId", required = true) final String directorId) {
		return ResponseEntity.ok(directorService.retrieve(directorId));
	}
	...
	public ResponseEntity<List<DirectorDto>> directorsRetrievalHandler() {
		return ResponseEntity.ok(directorService.retrieveAll());
	}
