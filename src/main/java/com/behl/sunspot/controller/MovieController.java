...
public class MovieController {
	...
	public ResponseEntity<Movie> movieRetreivalHandler(
		...
		return ResponseEntity.ok(movieService.retrieve(movieId));
	}
	...
	public ResponseEntity<List<MovieDto>> moviesRetrievalHandler() {
		return ResponseEntity.ok(movieService.retrieveAll());
	}
