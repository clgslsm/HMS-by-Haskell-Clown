...
public class _DBPopulator {
    ...
    private static Machine generateRandomMachine() {
        ...
        int avaiUse = random.nextInt(50) + 50; // Random number between 50 and 100
        int useCount = random.nextInt(avaiUse); // Random number less than avaiUse
    ...
    private static Medicine generateRandomMedicine() {
        ...
        int amount = random.nextInt(500) + 1; // Random number between 1 and 500
